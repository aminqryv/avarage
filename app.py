def hesabla_ortalama(ders_adi, ballar):
...
ders_1_ortalama = hesabla_ortalama(ders1, ballar1)
ders_2_ortalama = hesabla_ortalama(ders2, ballar2)
ders_3_ortalama = hesabla_ortalama(ders3, ballar3)
print("---------------------------------------------")
